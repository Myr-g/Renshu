...
const simple_prompt_form = document.getElementById("simple-prompt-form");
const simple_prompt_submission = document.getElementById("simple-prompt-submission");
const simple_prompt_cancel = document.getElementById("simple-prompt-cancel");
const simple_prompt_submit = document.getElementById("simple-prompt-submit");

const generator_contribution_form = document.getElementById("generator-contribution-form");
const generator_contribution_type = document.getElementById("contribution-type");
const contribution_guidelines_toggle = document.getElementById("contribution-guidelines-toggle");
const contribution_guidelines = document.getElementById("contribution-guidelines");
const contribution_example_toggle = document.getElementById("contribution-example-toggle");
const contribution_example = document.getElementById("contribution-example");
const generator_contribution_submission = document.getElementById("generator-contribution-submission");
